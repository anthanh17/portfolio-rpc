...
// inMemoryClient is an in-memory implementation of the Cachier interface. It stores
// key-value pairs in an in-memory map, protected by a mutex. It is used for caching
// data that does not need to persist across program runs.
...
// NewInMemoryClient creates a new in-memory cache implementation of the Cachier interface.
// The cache is thread-safe and uses a sync.Mutex to protect concurrent access.
// The logger parameter is used for logging any errors or other relevant information.
